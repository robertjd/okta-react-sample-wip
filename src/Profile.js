  ...
  render() {
    return <div>
      ...
      <Container text style={{ marginTop: '7em' }}>
        ...
        {this.state.userinfo &&
        <div>
          <Header as='h1'>My User Profile (ID Token Claims)</Header>
          ...
          <p>This route is protectd with the <code>&lt;SecureRoute&gt;</code> component, which will ensure that this page cannot be accessed until you have authenticated.</p>
          <Table>
            <thead>
              <tr>
